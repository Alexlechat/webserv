...
struct FileLoggerConfig
{
	...
	FileLoggerConfig(const FileLoggerConfig& src)
		: log_filepath(src.log_filepath)
		, log_min_lvl(src.log_min_lvl)
	{}

	FileLoggerConfig(const char* filepath, const char* min_lvl)
		: log_filepath(filepath)
		, log_min_lvl(Logger::stringToLevel(min_lvl))
	{}

	FileLoggerConfig(const std::string& filepath, Logger::LogLevel min_lvl)
		: log_filepath(filepath)
		, log_min_lvl(min_lvl)
	{}
